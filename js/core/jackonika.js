...
(function () {
    ...
    class JackonikaCore extends EmitterBase {
        ...
        init(opts = {}) {
            ...
            if (typeof this._optionsRef.onStatus === "function") {
                this.addEventListener("app:status", (e) => {
                    const { level, msg } = e.detail || {};
                    this._optionsRef.onStatus(level, msg);
                });
            }
    ...
    if (typeof window !== "undefined") {
        ...
        window.Jackonika.init = (opts) => window.Tonika.Jackonika.init(opts);
    }
