    ...
    class Chordonika {
        ...
        _initChordData() {
            this.chordData = {
                ...
                chordQualities: {
                    major:      { name:"major", label:"Major", symbol:"",   intervals:[0,4,7], priority:1 },
                    minor:      { name:"minor", label:"Minor", symbol:"m",  intervals:[0,3,7], priority:1 },
                    diminished: { name:"diminished", label:"Diminished", symbol:"°", intervals:[0,3,6], priority:1 },
                    augmented:  { name:"augmented", label:"Augmented", symbol:"+", intervals:[0,4,8], priority:2 },
                    major7:     { name:"major7", label:"Major 7th", symbol:"maj7", intervals:[0,4,7,11], priority:2 },
                    minor7:     { name:"minor7", label:"Minor 7th", symbol:"m7", intervals:[0,3,7,10], priority:2 },
                    dominant7:  { name:"dominant7", label:"Dominant 7th", symbol:"7", intervals:[0,4,7,10], priority:2 },
                    diminished7:{ name:"diminished7", label:"Diminished 7th", symbol:"°7", intervals:[0,3,6,9], priority:3 },
                    halfDiminished7:{ name:"halfDiminished7", label:"Half Diminished 7th", symbol:"ø7", intervals:[0,3,6,10], priority:3 },
                    sus2:       { name:"sus2", label:"Suspended 2nd", symbol:"sus2", intervals:[0,2,7], priority:2 },
                    sus4:       { name:"sus4", label:"Suspended 4th", symbol:"sus4", intervals:[0,5,7], priority:2 },
                }
            };
        }
        ...
        _calculateChord(rootNote, qualityName) {
            ...
            return { root: rootNote, quality: qualityName, symbol, notes, intervals: quality.intervals };
        }

        _findOptimalOctave(notes) {
            const baseOctave = 3;
            const keyboardRange = { min: 36, max: 71 };
        ...
        _handleChordChange() {
            ...
            if (rootNote && quality) {
                ...
                if (this.settings.onChordSelected) this.settings.onChordSelected(chord);
